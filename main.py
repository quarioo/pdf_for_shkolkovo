...
with fitz.open('data/open-week-11-planik-olymp.pdf') as doc:
    all_text = ''
    for page in doc:
...
doc = fitz.Document()
blank_page = fitz.open('data/test.pdf')
...
for key in tasks.keys():
    ...
    page.insert_htmlbox(rect, ' '.join(tasks[key]), css="* {font-family: 'serif';font-size:13px;}")

doc.save('data/tasks.pdf')
